...
def initial_kmeans_pp_centroids(k, path_1, path_2):
...
if __name__ == '__main__':
    check_args(k, max_iter)
    centroids, full_data_points, centroids_indexes = initial_kmeans_pp_centroids(k, file_name_1, file_name_2)
